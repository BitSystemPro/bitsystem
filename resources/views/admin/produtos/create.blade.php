    ...
    <div class="modal-content">
      ...
      <form action="{{ route('admin.produto.store') }}" method="POST" enctype="multipart/form-data" class="col s12">
        ...
        <div class="row">
          ...
          <div class="input-field col s6">
            <input name="preco" id="preco" type="number" class="validate" value="">
        ...
        <button type="submit" class="waves-effect waves-green btn green right" style="margin-right: 10px;">Cadastrar</button><br>
