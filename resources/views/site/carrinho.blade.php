  ...
  @if ($mensagem = Session::get('aviso'))
    ...
    <table class="striped">
        ...
        <tbody>
         @foreach ($itens as $item)
          <tr>
            <td><img src="{{ $item->attributes->image }}" alt="Produto" width="70" class="responsive-img circle"></td>
            <td>{{ $item->name }}</td>
            ...
            {{--BTN ATUALIZAR--}}
              <form action="{{ route('site.atualizacarrinho') }}" method="POST" enctype="multipart/form-data">
                ...
                <td>              
                <button class="btn-floating waves-effect waves-light orange" style="margin:5px;"><i class="material-icons">refresh</i></button>
              </form>
              ...
              <form action="{{ route('site.removecarrinho') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $item->id }}">
                <button class="btn-floating waves-effect waves-light red" style="margin:5px;"><i class="material-icons">delete</i></button>
              </form>
            </td>
          </tr>
          @endforeach
      ...
      <div class="card orange" style="margin-top:15px;">
        <div class="card-content white-text">
    ...
    @endif
      ...
      <div class="row container center">
        <a href="{{ route('site.index') }}" class="btn waves-effect waves-light blue" > Continuar coprando <i class="material-icons right">arrow_back</i></a>
